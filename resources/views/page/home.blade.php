...
<div class="content-page">  
        <div class="body-content">
            <!-- sản phẩm hot -->
            <div class="hot-product product row m-0 p-0">
            ...
            <!-- thịt gà đông lạnh -->
                ...
                <div class="cool-chicken product row m-0 p-0">
                    ...
                    <div class="col-12 col-md-2 my-3">                                          
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$ga1->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
            ...
            <!-- thịt gà tươi sạch -->
            <div class="fresh-chicken product row m-0 p-0">
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$ga2->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$bo_u_m->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$heo->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$trau->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$seafood->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$gs->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-2 my-3">                                              
                        <div class="card">
                            ...
                            <form>
                                ...
                                <button type="button" name="add-to-cart" class="btn btn-primary" data-id_product="{{$gv->id}}"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>
                            </form>
                            <!-- end add to cart by ajax -->
                            </div>
                        </div>
